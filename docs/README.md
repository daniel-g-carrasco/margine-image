...
| [17-keyboard-bindings.md](17-keyboard-bindings.md) | Hyprland-style keyboard layout for GNOME: static workspaces, native shortcuts, custom app launchers (kitty terminal, SUPER+E Nautilus), Forge tiling actions; full Hyprland→GNOME mapping |
