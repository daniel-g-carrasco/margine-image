...
| Phone Camera app (name/icon/id) | `build_files/system_files/usr/share/applications/dev.margine.PhoneCam.desktop` + `…/usr/libexec/margine/phone-cam-gui` | `dev.margine.PhoneCam`, `Margine Phone Cam` |
